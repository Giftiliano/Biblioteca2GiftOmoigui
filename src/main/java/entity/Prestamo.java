...
public class Prestamo {
    ...
    public Prestamo(Usuario usuario, Ejemplar ejemplar, LocalDate now) {
    ...
    public Prestamo( LocalDate fechaDevolucion, Usuario usuario, Ejemplar ejemplar, LocalDate fechaInicio) {
